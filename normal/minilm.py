...
class MAG(nn.Module):
    def __init__(self, hidden_size, beta_shift, dropout_prob):
        ...
        self.beta_shift = torch.nn.parameter.Parameter(torch.tensor(beta_shift))
...
class MAG_MiniLMForSequenceClassification(BertPreTrainedModel):
    def __init__(self, config, multimodal_config):
        super().__init__(config)
        self.num_labels = config.num_labels

        self.bert = MAG_MiniLM(config, multimodal_config)
